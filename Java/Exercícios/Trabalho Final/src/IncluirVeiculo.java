...
public class IncluirVeiculo extends JFrame {
    ...
    public IncluirVeiculo() throws SQLException {
        ...
        if (ultimoValorHora != null) {
            txt_valorHora.setText(String.valueOf(ultimoValorHora)); // Define o valor no JTextField
        } else {
            txt_valorHora.setText("0.0"); // Define um valor padrão caso não haja registro anterior
        }
